...
window.addEventListener("load",()=>{let t=["in 4","in 3","in 2","in 1","langsung klik"],r=setInterval(()=>{if(0===t.length){clearInterval(r);return}e.innerHTML=t.shift()},1e3)}),// HANDLE LINK CLICK
